...
pub const ALLOW_MOVING_CURSOR_AFTER_CLOSE_OR_MINIMISE: &str = "allow_moving_cursor_on_close_or_minimise";
...
fn validate_allow_moving_cursor_after_close_or_minimise(
  ...
  if !config_str.contains(ALLOW_MOVING_CURSOR_AFTER_CLOSE_OR_MINIMISE) {
    warn!(
      "[{}] was missing; adding it now with default value: {}",
...
impl ConfigurationProvider {
  ...
  pub fn set_bool(&mut self, name: &str, value: bool) {
    match name {
      ...
      ALLOW_MOVING_CURSOR_AFTER_CLOSE_OR_MINIMISE => self.config.general.allow_moving_cursor_after_close_or_minimise = value,
      &_ => {
