...
pub const ENABLE_HORIZONTAL_LAYOUT: &str = "enable_horizontal_layout";
...
fn validate_horizontal_layout(config_str: &str, configuration_provider: &mut ConfigurationProvider) {
  if !config_str.contains(ENABLE_HORIZONTAL_LAYOUT) {
    warn!("[{ENABLE_HORIZONTAL_LAYOUT}] was missing; adding it now with default value: false");
    configuration_provider.set_bool(ENABLE_HORIZONTAL_LAYOUT, false);
  }
}
...
impl Default for GeneralConfiguration {
  fn default() -> Self {
    Self {
      ...
      allow_moving_cursor_after_open_close_or_minimise: allow_moving_cursor_after_close_or_minimise(),
...
impl ConfigurationProvider {
  ...
  fn validate_config(&mut self, config_string: Option<String>) {
    if let Some(config_as_string) = config_string {
      ...
      validate_horizontal_layout(&config_as_string, self);
    } else {
  ...
  pub fn get_bool(&self, name: &str) -> bool {
    match name {
      ...
      ENABLE_HORIZONTAL_LAYOUT => self.config.general.enable_horizontal_layout,
      &_ => {
  ...
  pub fn set_bool(&mut self, name: &str, value: bool) {
    match name {
      ...
      ENABLE_HORIZONTAL_LAYOUT => self.config.general.enable_horizontal_layout = value,
      &_ => {
...
mod tests {
  ...
  fn new_with_file_manager_creates_default_when_file_does_not_exist() {
    ...
    assert!(!config.general.enable_horizontal_layout);
  ...
  fn new_with_file_manager_loads_existing_file() {
    ...
    assert!(loaded_config.general.enable_horizontal_layout);
  ...
  fn validate_config_writes_missing_fields_to_file() {
    ...
    let enable_horizontal_layout = format!("{} = false", ENABLE_HORIZONTAL_LAYOUT);
    ...
    assert!(config_string.contains(enable_horizontal_layout.as_str()));
  }
  ...
  fn reload_configuration_replaces_prior_configuration() {
    ...
    assert!(configuration_provider.config.general.enable_horizontal_layout);
    assert_eq!(
